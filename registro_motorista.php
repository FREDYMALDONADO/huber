    ...
    <div class="container"><br>
        <div class="row justify-content-center">
            <div class="col-8 p-5 bg-white shadow-lg rounded">
                ...
                include('config.php');
                session_start();
                if (isset($_POST['registro_motorista'])) {

                    $Nombre = $_POST['Nombre'];
                    $Fecha_de_ingreso = $_POST['Fecha_de_nacimiento'];
                    $Fecha_de_nacimiento= $_POST['Fecha_de_ingreso'];
                    $query = $conn->prepare("SELECT * FROM motorista WHERE id=:id");
                    ...
                    if ($query->rowCount() == 0) {
                        $query = $conn->prepare("INSERT INTO motorista(Nombre,Fecha_de_nacimiento,Fecha_de_ingreso) VALUES (:Nombre,:Fecha_de_nacimiento,:Fecha_de_ingreso)");
