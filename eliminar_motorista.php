...
<div class="container">
        ...
        <input type="hidden" name="id" value="<?php echo $row['id']; ?>" />
            ...
            <a href="admi_motorista.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; NO</a>
        </form>
    <?php
            } else {
    ?>
        <a href="admi_motorista.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i>REGRESAR</a>
    <?php
            }
    ?>
    </p>
